...
describe('calucltor test', function () {
    ...
    it('calcfunctionality', function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            protractor_1.browser.get("http://www.way2automation.com/angularjs-protractor/banking/#/login").then(function () {
                var _this = this;
                protractor_1.browser.getTitle().then(function (text) { return __awaiter(_this, void 0, void 0, function () {
                    var page;
                    return __generator(this, function (_a) {
                        console.log(text);
